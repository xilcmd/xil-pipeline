...
MAYA
(leaning in)
Meaning the cost of training came down enough that hoarding the weights stopped making sense?
DARIUS
Exactly. And once LLaMA was out — even the way it got out — you had thousands of people fine-tuning it within weeks. That's not something OpenAI can replicate internally.
[SFX: Coffee mug set down on desk]
MAYA
But there's a real tension here. Openness accelerates capability. And capability without guardrails...
DARIUS
